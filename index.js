 ...
 * 
 * I would use second method to reverse a string, because it is easy to read and efficient method to me. 
 * Which takes the string and splits it into an array of characters. 
 * Then it reverses the order of elements in the array.
 * Lastly it takes the reversed array and joins all the characters back together into a single string.
 * 
 */
